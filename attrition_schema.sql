...
CREATE TABLE attrition_data (
    ...
    overtime NVARCHAR(10),  -- Yes/No
    business_travel NVARCHAR(20),  -- Non-Travel/Travel_Frequently/Rarely
    distance_from_home INT,  -- in miles
    num_companies_worked INT,
    total_experience INT,
    training_times_last_year INT,
    
    -- Target Variable
    attrition NVARCHAR(10),  -- Yes/No (THIS IS WHAT WE PREDICT!)
...
CREATE TABLE attrition_predictions (
    ...
    attrition_probability DECIMAL(5,4),  -- 0.0000 to 1.0000
    attrition_prediction NVARCHAR(10),  -- Yes/No
...
CREATE TABLE model_performance (
    ...
    test_samples INT,
    features_used NVARCHAR(MAX)
);

-- ============================================
-- SAMPLE DATA FOR ATTRITION PREDICTION
-- ============================================
